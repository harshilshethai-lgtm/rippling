...
import { parseCsv, readFileAsText } from '../csvIo'
import { downloadCsv, toCsvString } from '../csvDraft'
import { classNames } from '../../../../lib/utils'

/**
 * Generic upload step for the CSV wizard.
 *
 * Props:
 *   onParsed(result | null)   — called whenever the parsed CSV changes
 *   buildTemplateRows()       — adapter-supplied fn → rows[][] for template download
 *   templateFilename          — download filename for the template
 *   extras                    — optional JSX rendered above the paste area
 *   initialFocusPaste         — if true, the paste area is auto-scrolled into view
 */
export default function UploadStep({
  onParsed,
  buildTemplateRows,
  templateFilename = 'rippling_template.csv',
  extras = null,
}) {
  ...
  function handleTemplateDownload() {
    ...
    downloadCsv(templateFilename, rows)
  }
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-[12.5px] text-rippling-muted leading-relaxed mb-2">
          Use the template as a starting point. Fill in the rows and upload or paste it back.
        </p>
        <button
          type="button"
      ...
      <div>
        ...
        <p className="text-[12.5px] text-rippling-muted leading-relaxed">
          Add a row for each employee. Use profile number, name, and/or email to identify them.
        </p>
      </div>
      ...
      <div>
        ...
        >
          ...
          {file && parsed ? (
            ...
            <>
              ...
              <p className="text-[13.5px] text-rippling-plum font-medium">Drop or select (.csv)</p>
        ...
        {/* Extras slot (e.g. "Download current draft") */}
        ...
        <div>
          ...
          <textarea
            ...
            placeholder={`Rippling profile number,Name,Email\n101,Jane Smith,jane.smith@acme.com`}
            rows={5}
